...
bot = telebot.TeleBot('7252122247:AAFa9Ec79dqVZrMi2SfDB_PjzRfOSv5__Fc')
...
Buy From :- @Ishugrapher
Official Channel :- https://t.me/MableSuck
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to 666 FREE DDOS🚀, {user_name}! ⚠️ PAID BHI SASTA HAI KHARID LO ABHI .
